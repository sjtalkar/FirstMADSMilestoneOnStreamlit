...
election_urban_rural_df = load_unemployment_rate_since_2019_df()

st.header(
    "Does the Covid-19 response changes between urban vs rural counties?",
    anchor="unemploymentandcovid",
)

st.altair_chart(ElectionUrbanRuralDensityPlot(election_urban_rural_df))

st.altair_chart(UrbanRuralCorrelation(election_urban_rural_df))
