...
**Effectiveness**:Cases are encoded using length, segmnts are encoded using color and further emphasized using stroke. 
Annotations are provided with a rolling tooltip as well as legend and a subtitle. """
)
...
st.write(
    alt.layer(highlight_segment, selectors, points, rules, tooltip_text) | make_selector
)
st.markdown("""---""")
