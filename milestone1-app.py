...
st.markdown(
    """
|<font size="1"> Name </font>|<font size="1"> Description </font>|<font size="1"> Key Variables</font> |<font size="1"> Size </font>|<font size="1"> Shape </font>|<font size="1"> Format </font>|<font size="1"> Access </font>|
|---|---|---|---|---|---|---|
|<font size="1"> State presidential election results dataset </font>|<font size="1"> *"This data file contains constituency (state-level) returns for elections to the U.S. presidency from 1976 to 2020"* </font>|<font size="1"> `year, candidatevotes, totalvotes` </font>|<font size="1"> 500KB </font>|<font size="1"> 4287 x 15 </font>|<font size="1"> CSV </font>|<font size="1"> [Harvard Dataverse website](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/42MVDX) </font>|
|<font size="1"> County presidential election results dataset </font>|<font size="1"> *"This dataset contains county-level returns for presidential elections from 2000 to 2020"* </font>|<font size="1"> `year, county_fips, county_name, party` </font>|<font size="1"> 7.4MB </font>|<font size="1"> 72603 x 12 </font>|<font size="1"> CSV </font>|<font size="1"> [Harvard Dataverse website](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/VOQCHQ) </font>|
|<font size="1"> COVID-19 cases and death rolling averages</font>|<font size="1">This dataset issued by the New York Times *"contains the daily number of new cases and deaths, the seven-day rolling average and the seven-day rolling average per 100,000 residents"* for all counties in the U.S. </font>|<font size="1"> `date, geoid, county, state, cases_avg_per_100k, deaths_avg_per_100k` </font>|<font size="1"> >85MB </font>|<font size="1"> >146M x 10 </font>|<font size="1"> CSV </font>|<font size="1"> [The New York Times GitHub page](https://github.com/nytimes/covid-19-data/tree/master/rolling-averages)</font>|
|<font size="1"> State level total COVID-19 vaccine dataset </font>|<font size="1"> This dataset issued by the US Centers for Disease Control and Prevention (CDC) contains the total COVID-19 Vaccine deliveries and administration data at the state level.</font>|<font size="1"> `State/Territory/Federal Entity, People with at least One Dose by State of Residence, Percent of Total Pop with at least One Dose by State of Residence` </font>|<font size="1"> 28KB </font>|<font size="1"> 63 x 62 </font>|<font size="1"> CSV </font>|<font size="1"> [The U.S. Centers for Disease Control website](https://covid.cdc.gov/covid-data-tracker/#vaccinations) </font>|
|<font size="1"> County level daily COVID-19 vaccine dataset </font>|<font size="1"> This dataset issued by the US Centers for Disease Control and Prevention (CDC) contains the daily COVID-19 Vaccine deliveries and administration data at the county level. </font>|<font size="1"> `Date, FIPS, Recip_County, Recip_State, Administered_Dose1_Pop_Pct` </font>|<font size="1"> 139MB </font>|<font size="1"> >840,000 x 27 </font>|<font size="1"> CSV </font>|<font size="1"> [The U.S. Centers for Disease Control website](https://data.cdc.gov/Vaccinations/COVID-19-Vaccinations-in-the-United-States-County/8xkx-amqh) </font>|
|<font size="1"> Mask-wearing survey dataset </font>|<font size="1"> This dataset is an estimate of mask usage by county in the United States released by The New York Times. It “comes from a large number of interviews conducted online“ in 2020 between July 2nd and July 14th. </font>|<font size="1"> `COUNTYFP, NEVER, RARELY, SOMETIMES, FREQUENTLY, ALWAYS` </font>|<font size="1"> 109KB </font>|<font size="1"> 3143 x 6 </font>|<font size="1"> CSV </font>|<font size="1"> [The New York Times GitHub page](https://github.com/nytimes/covid-19-data/tree/master/mask-use) </font>|
|<font size="1"> Census Bureau population census and estimates dataset </font>|<font size="1"> This dataset contains the 2010 population census data per county and the 2011~2020 population estimates. We are mainly interested in the 2020 estimates </font>|<font size="1"> `SUMLEV, STATE, STNAME, CTYNAME, POPESTIMATE2020` </font>|<font size="1"> 3.7MB </font>|<font size="1"> 3195 x 180 </font>|<font size="1"> CSV </font>|<font size="1"> [U.S. Census Bureau website](https://www.census.gov/programs-surveys/popest/technical-documentation/research/evaluation-estimates/2020-evaluation-estimates/2010s-counties-total.html) </font>|
|<font size="1"> Unemployment rate dataset </font>|<font size="1"> The dataset is the collection of labor force county data tables for 2020 issued by the U.S. Bureau of Labor Statistics </font>|<font size="1"> `state_FIPS, county_FIPS, year, month , unemployment_rate` </font>|<font size="1"> 7.69MB </font>|<font size="1"> >96,000 x 7 </font>|<font size="1"> CSV </font>|<font size="1"> [Bureau of Labor Statistics website](https://www.bls.gov/web/metro/laucntycur14.zip) only gives access to the last 14 months of data. To capture the unemployment rate for the desired period, we used the BLS v2 public APIs. Registration is required [here](https://data.bls.gov/registrationEngine/). The LAUS codes of all counties must be passed to the API.</font>|
|<font size="1"> Census Urban and Rural dataset </font>|<font size="1"> The dataset classifies all the counties in the U.S. as rural or urban areas </font>|<font size="1">`2015 GEOID, State, 2015 Geography Name, 2010 Census Percent Rural`</font>|<font size="1"> 302KB </font>|<font size="1"> 3142 x 8 </font>|<font size="1"> XLS </font>|<font size="1"> [U.S. Census Bureau website](https://www.census.gov/programs-surveys/geography/guidance/geo-areas/urban-rural.html) </font>|
""",
    unsafe_allow_html=True,
)
